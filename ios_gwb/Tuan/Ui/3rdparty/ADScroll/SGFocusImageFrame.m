...
- (void)setupViews
{
    ...
    if (version >= 6.0){
        ...
        [_pageControl setCurrentPageIndicatorTintColor:[UIColor colorWithRed:60/255.0 green:180.0/255.0 blue:226.0/255.0 alpha:1.0]];
        [_pageControl setPageIndicatorTintColor:[UIColor colorWithRed:188.0/255.0 green:188.0/255.0 blue:188.0/255.0 alpha:1.0]];
    }
    ...
    */
    ...
    for (int i = 0; i < imageItems.count; i++) {
        ...
        UIImageViewActive *imageView = [[UIImageViewActive alloc] initWithFrame:CGRectMake(i * _scrollView.frame.size.width, 0, _scrollView.frame.size.width, _scrollView.frame.size.height)];
        //imageView.image = item.image;
        [imageView setImageWithURL:[NSURL URLWithString:[StringUtil emptyForNil:item.url]]
                  placeholderImage:[UIImage imageNamed:@"advertisement_default@2x.png"]];
        imageView.contentMode =  UIViewContentModeScaleAspectFill;
        imageView.clipsToBounds = YES;
        
        [_scrollView addSubview:imageView];
        [_scrollView addSubview:item.button];
        [imageView release];
    }
